...
class RecipeAuthorResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->image() // validasi hanya bisa image
                ->required(),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                //data table fillament
                Tables\Columns\TextColumn::make('name') //memunculkan nama
                ->searchable(),

                Tables\Columns\ImageColumn::make('photo') //memunculkan icon
                ->circular(),
            ])
            ->filters([
                //
